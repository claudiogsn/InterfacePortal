<?php
/**
 * AuditoriaPortalSelectionList Record selection
 * @author  <your name here>
 */
class AuditoriaPortalSelectionList extends TPage
{
    ...
    public function showResults()
    {
        ...
        $datagrid->addColumn( new TDataGridColumn('usuario',  'Usuario',  'left') );
